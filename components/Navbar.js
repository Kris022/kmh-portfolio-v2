  ...
  return (
    <div className="fixed left-0 top-0 w-full z-50 ease-in duration-300 bg-[#1F2937] text-white">
      <div className="flex justify-between items-center p-4 text-4xl max-w-[1240px] m-auto">
        ...
        <div className={mobileNav ? "sm:hidden absolute inset-0 w-full h-screen bg-zinc-800 flex flex-col justify-center items-center text-3xl text-center ease-in duration-100" : "hidden"}>
